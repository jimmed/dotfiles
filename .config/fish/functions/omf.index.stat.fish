# Defined in /home/jim/.local/share/omf/pkg/omf/functions/index/omf.index.stat.fish @ line 1
function omf.index.stat --description 'Get package properties' --argument name
	if test -z "$name"
    return 1
  end
