# Defined in /home/jim/.local/share/omf/pkg/omf/functions/index/omf.index.query.fish @ line 1
function omf.index.query --description 'Query packages in the index'
	set -l q_type any
  set -l q_name ''
  set -l q_text ''
