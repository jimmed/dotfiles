# Defined in /usr/share/fish/functions/fish_default_key_bindings.fish @ line 1
function fish_default_key_bindings --description 'Default (Emacs-like) key bindings for fish'
	if contains -- -h $argv
