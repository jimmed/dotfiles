# Defined in /home/jim/.local/share/omf/pkg/omf/functions/index/omf.index.repositories.fish @ line 1
function omf.index.repositories --description 'Manage package repositories'
